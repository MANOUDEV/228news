...
Route::get('/frontoffice/header/societe', [IncludesController::class, 'societeRequestData']);
...
Route::get('/frontoffice/header/communique', [IncludesController::class, 'communiqueRequestData']);
